...
import cn.itsource.meijia.query.SkuQuery;
...
public class SkuController {
    ...
    */
    ...
    public PageList<Sku> page(@RequestBody SkuQuery query)
    {
    ...
    @RequestMapping(value = "/sku/skuByProductId",method = RequestMethod.GET)
    public List<Sku> skuByProductId(@Param("productId") Long productId){
