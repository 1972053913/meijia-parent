...
import cn.itsource.meijia.service.IProductExtService;
import cn.itsource.meijia.domain.ProductExt;
import cn.itsource.meijia.query.ProductExtQuery;
...
public class ProductExtController {
    ...
    */
    ...
    public PageList<ProductExt> page(@RequestBody ProductExtQuery query)
    {
